...
public class HelpCommand extends Command {
	...
	public void execute() {
		System.out.print("\nTo start a game, type start followed by which side you want to play and the size of the board "
				...
				+ "For a special Tic Tac Toe variant, type 'start lightsout' :).  The rules are the same, except when you pick your move, you also fill in the adjacent squares (top, bottom, left, right).  If an adjacent square already has your mark, nothing happens, and if it has your opponent's mark, then it goes blank.\n\n"
				+ "Command: ");
	}
}
